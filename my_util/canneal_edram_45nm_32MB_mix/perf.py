...
#python perf.py canneal.log canneal.stats 1 ooo_l3
...
#print >>fout, "l1_d_num_read=%d l1_d_num_read_hit=%d l1_d_num_read_miss=%d l1_d_num_write=%d l1_d_num_write_hit=%d l1_d_num_write_miss=%d l1_d_num_update=%d l1_d_num_insert=%d \n" %(l1_d_num_read,
print >>fout, "%d %d %d %d %d %d %d %d " %(l1_d_num_read,
                                           ...
                                           l1_d_num_update,
                                           l1_d_num_insert),
#print >>fout, "l1_i_num_read=%d l1_i_num_read_hit=%d l1_i_num_read_miss=%d l1_i_num_write=%d l1_i_num_write_hit=%d l1_i_num_write_miss=%d l1_i_num_update=%d l1_i_num_insert=%d \n" %(l1_i_num_read,
print >>fout, "%d %d %d %d %d %d %d %d " %(l1_i_num_read,
                                           ...
                                           l1_i_num_update,
                                           l1_i_num_insert),
#print >>fout, "l2_num_read=%d l2_num_read_hit=%d l2_num_read_miss=%d l2_num_write=%d l2_num_write_hit=%d l2_num_write_miss=%d l2_num_update=%d l2_num_insert=%d \n" %(l2_num_read,
print >>fout, "%d %d %d %d %d %d %d %d " %(l2_num_read,
                                           ...
                                           l2_num_update,
                                           l2_num_insert),
#print >>fout, "l3_num_read=%d l3_num_read_hit=%d l3_num_read_miss=%d l3_num_write=%d l3_num_write_hit=%d l3_num_write_miss=%d l3_num_update=%d l3_num_insert=%d num_refresh=%d \n" %(l3_num_read,
